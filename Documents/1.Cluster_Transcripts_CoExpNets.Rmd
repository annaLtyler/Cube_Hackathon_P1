...
all.packages <- c("pheatmap", "gprofiler2", "CoExpNets", "qtl2")
...
module.genes <- module_genes(co.exp.net)
enrich.file <- file.path(clust.dir, "enrich.RDS")
...
```{r mod_eig}
mod.eig <- as.matrix(co.exp.net$MEs)
...
scan.file <- here("Results", "CoExpNet_Clusters", tissue.type, "qtl.scan.RDS")
