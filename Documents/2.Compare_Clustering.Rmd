...
#and one to better visualize the higher LOD scores.
#quartz(width = 10, height = 10)
coexp.cor.lod <- match_cor_lod(coexp.qtl, coexp.cor, 10, 0.3)
```
...
plot_example <- function(me.name, clust.type, min.lod = 4){
  ...
  plot(test.qtl, lodcol = me.locale, map = map, main = "Module Eigengene LOD Scores")
  ...
  plot_coefCC(allele.me, map = map, main = "Module Eigengene Coefficients")
...
#plot.enrichment(coexp.enrich$"yellow")
```
...
#plot.enrichment(wgcna.enrich$me.wgcna)
```
